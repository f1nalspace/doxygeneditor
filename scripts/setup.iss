...
#define AppExe '..\publish\DoxygenEditor.exe'
...
Source: "..\publish\*.exe.config"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "..\publish\*.dll.config"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
